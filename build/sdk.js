  ...
  function $(e, o) {
      ...
      return Object.create({
          ...
          withAttributes: function(r) {
              return $(this.converter, E({}, this.attributes, r))
          },
          withConverter: function(r) {
              return $(E({}, this.converter, r), this.attributes)
          }
      }, {
          attributes: {
...
`
    ...
    , M = e => {
      T("cw-bubble-holder", e),
      T("cw-widget-holder", e),
      T("cw-widget-styles", e)
  }
    , y = (e, o) => {
    ...
    , R = ({referrerURL: e, referrerHost: o}) => {
    ...
    , z = e => W(e) === A[1]
    , re = e => N.includes(e) ? e : N[0]
    , P = e => e === "flat"
    , V = e => H.includes(e) ? e : H[0]
    , se = "M240.808 240.808H122.123C56.6994 240.808 3.45695 187.562 3.45695 122.122C3.45695 56.7031 56.6994 3.45697 122.124 3.45697C187.566 3.45697 240.808 56.7031 240.808 122.122V240.808Z"
    ...
    , L = {
      utf8: {
          stringToBytes: function(e) {
              return L.bin.stringToBytes(unescape(encodeURIComponent(e)))
          },
          bytesToString: function(e) {
              return decodeURIComponent(escape(L.bin.bytesToString(e)))
          }
      },
      bin: {
          stringToBytes: function(e) {
...
*/
  var ve = function(e) {
      return e != null && (G(e) || xe(e) || !!e._isBuffer)
  };
  function G(e) {
  ...
  (function() {
      var e = me
        ...
        , r = function(n, u) {
          ...
          for (var i = e.bytesToWords(n), h = n.length * 8, a = 1732584193, s = -271733879, d = -1732584194, l = 271733878, w = 0; w < i.length; w++)
              i[w] = (i[w] << 8 | i[w] >>> 24) & 16711935 | (i[w] << 24 | i[w] >>> 8) & 4278255360;
          i[h >>> 5] |= 128 << h % 32,
          i[(h + 64 >>> 9 << 4) + 14] = h;
          for (var b = r._ff, p = r._gg, f = r._hh, m = r._ii, w = 0; w < i.length; w += 16) {
              var Re = a
                , Ne = s
                , He = d
                , We = l;
              a = b(a, s, d, l, i[w + 0], 7, -680876936),
              l = b(l, a, s, d, i[w + 1], 12, -389564586),
              d = b(d, l, a, s, i[w + 2], 17, 606105819),
              s = b(s, d, l, a, i[w + 3], 22, -1044525330),
              a = b(a, s, d, l, i[w + 4], 7, -176418897),
              l = b(l, a, s, d, i[w + 5], 12, 1200080426),
              d = b(d, l, a, s, i[w + 6], 17, -1473231341),
              s = b(s, d, l, a, i[w + 7], 22, -45705983),
              a = b(a, s, d, l, i[w + 8], 7, 1770035416),
              l = b(l, a, s, d, i[w + 9], 12, -1958414417),
              d = b(d, l, a, s, i[w + 10], 17, -42063),
              s = b(s, d, l, a, i[w + 11], 22, -1990404162),
              a = b(a, s, d, l, i[w + 12], 7, 1804603682),
              l = b(l, a, s, d, i[w + 13], 12, -40341101),
              d = b(d, l, a, s, i[w + 14], 17, -1502002290),
              s = b(s, d, l, a, i[w + 15], 22, 1236535329),
              a = p(a, s, d, l, i[w + 1], 5, -165796510),
              l = p(l, a, s, d, i[w + 6], 9, -1069501632),
              d = p(d, l, a, s, i[w + 11], 14, 643717713),
              s = p(s, d, l, a, i[w + 0], 20, -373897302),
              a = p(a, s, d, l, i[w + 5], 5, -701558691),
              l = p(l, a, s, d, i[w + 10], 9, 38016083),
              d = p(d, l, a, s, i[w + 15], 14, -660478335),
              s = p(s, d, l, a, i[w + 4], 20, -405537848),
              a = p(a, s, d, l, i[w + 9], 5, 568446438),
              l = p(l, a, s, d, i[w + 14], 9, -1019803690),
              d = p(d, l, a, s, i[w + 3], 14, -187363961),
              s = p(s, d, l, a, i[w + 8], 20, 1163531501),
              a = p(a, s, d, l, i[w + 13], 5, -1444681467),
              l = p(l, a, s, d, i[w + 2], 9, -51403784),
              d = p(d, l, a, s, i[w + 7], 14, 1735328473),
              s = p(s, d, l, a, i[w + 12], 20, -1926607734),
              a = f(a, s, d, l, i[w + 5], 4, -378558),
              l = f(l, a, s, d, i[w + 8], 11, -2022574463),
              d = f(d, l, a, s, i[w + 11], 16, 1839030562),
              s = f(s, d, l, a, i[w + 14], 23, -35309556),
              a = f(a, s, d, l, i[w + 1], 4, -1530992060),
              l = f(l, a, s, d, i[w + 4], 11, 1272893353),
              d = f(d, l, a, s, i[w + 7], 16, -155497632),
              s = f(s, d, l, a, i[w + 10], 23, -1094730640),
              a = f(a, s, d, l, i[w + 13], 4, 681279174),
              l = f(l, a, s, d, i[w + 0], 11, -358537222),
              d = f(d, l, a, s, i[w + 3], 16, -722521979),
              s = f(s, d, l, a, i[w + 6], 23, 76029189),
              a = f(a, s, d, l, i[w + 9], 4, -640364487),
              l = f(l, a, s, d, i[w + 12], 11, -421815835),
              d = f(d, l, a, s, i[w + 15], 16, 530742520),
              s = f(s, d, l, a, i[w + 2], 23, -995338651),
              a = m(a, s, d, l, i[w + 0], 6, -198630844),
              l = m(l, a, s, d, i[w + 7], 10, 1126891415),
              d = m(d, l, a, s, i[w + 14], 15, -1416354905),
              s = m(s, d, l, a, i[w + 5], 21, -57434055),
              a = m(a, s, d, l, i[w + 12], 6, 1700485571),
              l = m(l, a, s, d, i[w + 3], 10, -1894986606),
              d = m(d, l, a, s, i[w + 10], 15, -1051523),
              s = m(s, d, l, a, i[w + 1], 21, -2054922799),
              a = m(a, s, d, l, i[w + 8], 6, 1873313359),
              l = m(l, a, s, d, i[w + 15], 10, -30611744),
              d = m(d, l, a, s, i[w + 6], 15, -1560198380),
              s = m(s, d, l, a, i[w + 13], 21, 1309151649),
              a = m(a, s, d, l, i[w + 4], 6, -145523070),
              l = m(l, a, s, d, i[w + 11], 10, -1120210379),
              d = m(d, l, a, s, i[w + 2], 15, 718787259),
              s = m(s, d, l, a, i[w + 9], 21, -343485551),
              a = a + Re >>> 0,
              s = s + Ne >>> 0,
              d = d + He >>> 0,
              l = l + We >>> 0
          }
          return e.endian([a, s, d, l])
      };
      r._ff = function(n, u, i, h, a, s, d) {
          var l = n + (u & i | ~u & h) + (a >>> 0) + d;
          return (l << s | l >>> 32 - s) + u
      }
      ,
      r._gg = function(n, u, i, h, a, s, d) {
          var l = n + (u & h | i & ~h) + (a >>> 0) + d;
          return (l << s | l >>> 32 - s) + u
      }
      ,
      r._hh = function(n, u, i, h, a, s, d) {
          var l = n + (u ^ i ^ h) + (a >>> 0) + d;
          return (l << s | l >>> 32 - s) + u
      }
      ,
      r._ii = function(n, u, i, h, a, s, d) {
          var l = n + (i ^ (u | ~h)) + (a >>> 0) + d;
          return (l << s | l >>> 32 - s) + u
      }
      ,
  ...
  const Ce = fe(ye)
    ...
    , Se = [...J, "identifier_hash"]
    , D = () => {
      const e = "cw_user_"
        , {websiteToken: o} = window.$chatwoot;
      return `${e}${o}`
  }
    , Ee = ({identifier: e="", user: o}) => `${Se.reduce( (c, r) => `${c}${r}${o[r] || ""}`, "")}identifier ${e}`
    , Be = (...e) => Ce(Ee(...e))
    , _e = e => J.reduce( (o, t) => o || !!e[t], !1)
    , I = (e, o, {expires: t=365, baseDomain: c=void 0}={}) => {
      const r = {
          expires: t,
          sameSite: "Lax",
          domain: c
    ...
    , Te = async (e="", o) => {
      ...
      if (t) {
          const {type: r="dashboard", alertTone: n="ding"} = o || {}
            , u = `${e}/audio/${r}/${n}.mp3`
            , i = new Request(u);
          fetch(i).then(h => h.arrayBuffer()).then(h => (t.decodeAudioData(h).then(c),
          new Promise(a => a()))).catch( () => {}
          )
      }
  }
    , Me = ({origin: e, conversationCookie: o, websiteToken: t, locale: c}) => {
  ...
  const ee = (e, o="") => I("cw_conversation", e, {
      baseDomain: o
  })
    , De = e => {
      const o = Le(new Date, 1);
      I("cw_snooze_campaigns_till", Number(o), {
          expires: o,
          baseDomain: e
      })
  }
    , g = {
      ...
      createFrame: ({baseUrl: e, websiteToken: o}) => {
          ...
          P(window.$chatwoot.widgetStyle) && (n += " woot-widget-holder--flat"),
          y(v, n),
      ...
      events: {
          loaded: e => {
              ...
              window.$chatwoot.resetTriggered || U({
                  eventName: be
              })
          }
          ,
          ...
          setBubbleLabel(e) {
              ae(window.$chatwoot.launcherTitle || e.label)
          },
          setAuthCookie({data: {widgetAuthToken: e}}) {
              ee(e, window.$chatwoot.baseDomain)
          },
          setCampaignReadOn() {
              De(window.$chatwoot.baseDomain)
          },
          toggleBubble: e => {
              let o = {};
          ...
          handleNotificationDot: e => {
              ...
              e.unreadMessageCount > 0 && !o.classList.contains("unread-notification") ? y(o, "unread-notification") : e.unreadMessageCount === 0 && B(o, "unread-notification")
          }
          ,
          closeChat: () => {
              S({
      ...
      onLoad: ({widgetColor: e}) => {
          ...
          g.getBubbleHolder().length)
              return;
          de(window.$chatwoot.hideMessageBubble),
          ie();
          let t = "woot-widget-bubble"
            , c = `woot-elements--${window.$chatwoot.position} woot-widget-bubble woot--close woot--hide`;
          P(window.$chatwoot.widgetStyle) && (t += " woot-widget-bubble--flat",
          c += " woot-widget-bubble--flat"),
          ue(e) && (t += " woot-widget-bubble-color--lighter",
    ...
    , Ie = "sdk-set-bubble-visibility"
    , Oe = ({baseUrl: e, websiteToken: o}) => {
      if (window.$chatwoot)
          return;
      window.Turbo && document.addEventListener("turbo:before-render", n => M(n.detail.newBody)),
      window.Turbolinks && document.addEventListener("turbolinks:before-render", n => {
          M(n.data.newBody)
      }
      ),
      document.addEventListener("astro:before-swap", n => M(n.newDocument.body));
      ...
      window.$chatwoot = {
          ...
          toggleBubbleVisibility(n) {
              ...
              y(u, "woot-hidden"),
              window.$chatwoot.hideMessageBubble = !0) : n === "show" && (B(u, "woot-hidden"),
              B(i, "woot-widget--without-bubble"),
